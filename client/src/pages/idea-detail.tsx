...
export default function IdeaDetail() {
  ...
  // Fetch the functional requirements document
  const fetchFunctionalRequirements = async () => {
    try {
      setIsLoadingFunctionalRequirements(true);
      ...
      toast({
        title: "Error",
        description: "Failed to load functional requirements",
        variant: "destructive",
      });
    } finally {
      setIsLoadingFunctionalRequirements(false);
    }
  };
                      ...
                      <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden p-8">
                        ...
                        {isLoadingFunctionalRequirements ? (
                          ...
                          <div className="text-center py-8">
                            ...
                            <h4 className="text-lg font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-2">
                              Forging Your Functional Requirements Document
                            </h4>
                            <p className="text-neutral-600 mb-2">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center space-x-3">
                                  <Button 
                                    ...
                                    className="bg-gradient-to-r from-amber-500 to-amber-700 hover:from-amber-600 hover:to-amber-800"
                                  >
                                    {isGeneratingFunctionalRequirements ? (
                                      <>
                                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                                        Retrying...
                                      </>
                                ...
                                <DialogContent className="sm:max-w-[550px]">
                                  ...
                                  <div className="py-4">
                                    <Textarea 
                                      ...
                                      placeholder="E.g., Include more specific details about user interface features, focus on data validation requirements..."
                                      className="min-h-[150px]"
                                    />
                                  </div>
                                  <DialogFooter>
                          ...
                          <div className="py-8">
                            <div className="mb-6">
                              ...
                              <Textarea
                                value={functionalRequirementsNotes}
                                onChange={(e) => setFunctionalRequirementsNotes(e.target.value)}
                                placeholder="e.g., Specific user features, UI/UX requirements, integrations needed..."
                                className="h-24"
                              />
                            </div>
                            <div className="flex justify-center">
                              ...
                              >
                                <Hammer className="mr-2 h-4 w-4" />
                                {isGeneratingFunctionalRequirements ? 'Generating...' : 'Generate Functional Requirements'}
                              </Button>
                            </div>
                          </div>
                        )}
